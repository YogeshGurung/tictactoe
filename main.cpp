/* Simple Tic-Tac-Toe program for the project submission for unit assessment */
#include <iostream>
#include <stdlib.h>
using namespace std;
void printBoard();
...
int player = 1;
int main() {
	cout << "\n***************\nTic Tac Toe\n***************\n\nGame Instruction:\nPlease follow the key map to place the blank space and type numbers between 1-8. ";
...
start:
	...
	if (checkWinner() == 10) {
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! Sorry, it is a tie!         *\n";
		cout << "***********************************\n";
	...
	if (checkWinner() == player) {
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! You have won the match!   *\n";
		cout << "***********************************\n";
		cout << "\nPress any key to play again...\n";
		char c;
		cin >> c;
		...
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! You have lost the match, try again!    *\n";
		cout << "***********************************\n";
		cout << "\nPress any key to play again...\n";
		char c;
		cin >> c;
...
secround:
	...
	if (checkWinner() == 10) {
		...
		cout << "* Game over! Sorry, it is a tie!         *\n";
		cout << "***********************************\n";
		cout << "\nPlease press any key to play again...\n";
		char c;
		cin >> c;
		player = 1;
		resetGame();
	...
	if (checkWinner() == player) {
		...
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! You have lost, try again!    *\n";
		cout << "***********************************\n";
		cout << "\nPlease press any key to play again...\n";
		char c;
		cin >> c;
...
ask:
	...
	cin >> input;
	if (input > 9) {
		cout << "Please check the key map board to fill the blank space.\n";
		goto ask;
	}
	else if (input < 1) {
		cout << "Please check the key map board to fill the blank space.\n";
